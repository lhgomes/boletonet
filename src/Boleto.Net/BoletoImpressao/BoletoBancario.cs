...
.Replace("@NOSSONUMERO", Boleto.NossoNumero)
				...
				.Replace("@=VALORDOCUMENTO", (Boleto.ValorBoleto == 0 ? "" : Boleto.ValorBoleto.ToString("C", System.Globalization.CultureInfo.GetCultureInfo("PT-BR"))))
				.Replace("@VALORCOBRADO", (Boleto.ValorCobrado == 0 ? "" : Boleto.ValorCobrado.ToString("C", System.Globalization.CultureInfo.GetCultureInfo("PT-BR"))))
				.Replace("@OUTROSACRESCIMOS", "")
				.Replace("@OUTRASDEDUCOES", "")
				.Replace("@DESCONTOS", (Boleto.ValorDesconto == 0 ? "" : Boleto.ValorDesconto.ToString("C", System.Globalization.CultureInfo.GetCultureInfo("PT-BR"))))
				...
				.Replace("@MORAMULTA", (Boleto.ValorMulta == 0 ? "" : Boleto.ValorMulta.ToString("C", System.Globalization.CultureInfo.GetCultureInfo("PT-BR"))))
